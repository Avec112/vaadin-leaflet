...
@PWA(name = "Map", shortName = "Map", enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Map logo"));
        logoLayout.add(new H1("Vaadin Leaflet Map"));
